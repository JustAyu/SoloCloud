...
from SoloCloud.utils import AdminRightsCheck
from SoloCloud.utils.database import is_active_chat, is_nonadmin_chat
from SoloCloud.utils.decorators.language import languageCB
from SoloCloud.utils.inline import close_markup, speed_markup
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    try:
        await AyushSolo.speedup_stream(
            chat_id,
            file_path,
            speed,
            playing,
